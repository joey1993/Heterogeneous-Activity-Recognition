...
def main():
	...
	y_test_predict_watch = decisionTree(X_train_watch,y_train_watch,X_test_watch)
	...
	y_test_predict_phones = decisionTree(X_train_phones,y_train_phones,X_test_phones) 
